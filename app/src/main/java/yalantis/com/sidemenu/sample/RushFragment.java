...
import static yalantis.com.sidemenu.sample.R.layout.activity_rush_fragment;
...
public class RushFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ArrayList<Menus> l =new ArrayList<Menus>( CallWebService.CallMazaganWebSousMenu("ClubRush"));
