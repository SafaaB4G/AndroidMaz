...
import static yalantis.com.sidemenu.sample.R.layout.activity_kids_fragment;
...
public class KidsFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ArrayList<Menus> l =new ArrayList<Menus>( CallWebService.CallMazaganWebSousMenu("KidzClub"));
