...
public class SpaActivity  extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (button1 != null ) {
            button1.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    final ArrayList<MenuPrincipale> l = new ArrayList<MenuPrincipale>(CallMazaganWebServicePincipale("Spa"));
                    ...
                    mDialog = new Dialog(SpaActivity.this);
                    mDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                    mDialog.setContentView(R.layout.dialog_spa);
    ...
    private void setupViewPager(ViewPager viewPager) {
        SpaActivity.ViewPagerAdapter adapter = new SpaActivity.ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFragment(new SpaFragment(),"Spa et Hamam ");
        adapter.addFragment(new FitnessFragment() ,"Fitness ");
        adapter.addFragment(new YogaFragment() , "Hot Yoga ");
