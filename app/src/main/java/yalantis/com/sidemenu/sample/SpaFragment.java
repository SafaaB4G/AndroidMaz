...
import static yalantis.com.sidemenu.sample.R.layout.activity_spa_fragment;
...
public class SpaFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ArrayList<Menus> l =new ArrayList<Menus>( CallWebService.CallMazaganWebSousMenu("SpaHammam"));
