...
import static yalantis.com.sidemenu.sample.R.layout.activity_yoga_fragment;
...
public class YogaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ArrayList<Menus> l =new ArrayList<Menus>( CallWebService.CallMazaganWebSousMenu("MazaganHotYoga"));
