...
import static yalantis.com.sidemenu.sample.R.layout.activity_chambre_fragment;

public class ChambreFragment extends ListFragment implements ImageGalleryAdapter.ImageThumbnailLoader, FullScreenImageGalleryAdapter.FullScreenImageLoader{
    private PaletteColorType paletteColorType;

    private List<ListItem> l;

    public ChambreFragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       l = new ArrayList<ListItem>();
        ...
        l.add(new ListItem("Pool View Room", R.drawable.hebergement));
        l.add(new ListItem("Partial Ocean View Room", R.drawable.hebergement));

        l.add(new ListItem("Ocean View Room", R.drawable.hebergement));
        l.add(new ListItem("Prime Ocean View Room", R.drawable.hebergement));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(activity_chambre_fragment, container, false);
    }
       ...
       super.onListItemClick(l, v, position, id);
        ...
        switch(position){
            case 0:
                 ...
                 photos = CallWebService.CallMazaganWebphoto("PoolViewRoom");
                Log.println(Log.ASSERT,"","ghir les les url :"+photos);
                ...
                if (photos != null) {
                    for (Photos p : photos) {
                       ...
                       //this code for the carosselle image
            ...
            case 1:
                 ...
                 photos = CallWebService.CallMazaganWebphoto("PartialOceanViewRoom");
                ...
                if (photos != null) {
                    for (Photos p : photos) {
                        ...
                        url.add(p.getPhoto());
                        Log.println(Log.ASSERT, "here", "" + p.getPhoto());
                    }
                    Bundle bundle = new Bundle();
                    bundle.putStringArrayList(ImageGalleryActivity.KEY_IMAGES, url);
                    bundle.putString(ImageGalleryActivity.KEY_TITLE, "Carosselle image");
            ...
            case 2:
                ...
                photos = CallWebService.CallMazaganWebphoto("OceanViewRoom");
                Log.println(Log.ASSERT,"","photos Object 3amer"+photos);
                url= new ArrayList<String>() ;
                Log.println(Log.ASSERT,"","ghir les les url :"+url);
            ...
            case 3:
                ...
                photos = CallWebService.CallMazaganWebphoto("PrimeOceanViewRoom");
                Log.println(Log.ASSERT,"","photos Object 3amer"+photos);
                url= new ArrayList<String>() ;
                Log.println(Log.ASSERT,"","ghir les les url :"+url);
