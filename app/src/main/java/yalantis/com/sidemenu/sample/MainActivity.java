    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     // create table
        ...
        if (button1 != null ) {
            button1.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    final ArrayList<Menus>l =new ArrayList<Menus>( CallWebService.CallMazaganWebSousMenu("Chambre"));

                    final ArrayList<Menus>lS =new ArrayList<Menus>( CallWebService.CallMazaganWebSousMenu("Suite"));

                    final ArrayList<Menus>lV =new ArrayList<Menus>( CallWebService.CallMazaganWebSousMenu("Villa"));
                    ...
                    mDialog.setContentView(R.layout.my_dialog_fragment);
                    textView = (TextView) mDialog.findViewById(R.id.content);
                    textView1 = (TextView) mDialog.findViewById(R.id.dialogtitle);
                    textView2 = (TextView) mDialog.findViewById(R.id.cont);
                    textView3 = (TextView) mDialog.findViewById(R.id.dialog);

                    textView4 = (TextView) mDialog.findViewById(R.id.dialog1);
                    textView5 = (TextView) mDialog.findViewById(R.id.cont1);
                    ...
                    textView1.setText(""+l.get(0).getTitre());
                    textView2.setText(""+lS.get(0).getDescription());
                    textView3.setText(""+lS.get(0).getTitre());
                    textView4.setText(""+lV.get(0).getTitre());
                    textView5.setText(""+lV.get(0).getDescription());
...
//create the menu
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ChambreFragment(),getResources().getString(R.string.one));
        adapter.addFragment(new SuiteFragment() , getResources().getString(R.string.two));
        adapter.addFragment(new VillaFragment() , getResources().getString(R.string.tree));
