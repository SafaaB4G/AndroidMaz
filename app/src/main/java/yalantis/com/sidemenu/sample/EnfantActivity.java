...
public class EnfantActivity  extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener(){
            public void onClick(View arg0) {
                final ArrayList<MenuPrincipale> l = new ArrayList<MenuPrincipale>(CallMazaganWebServicePincipale("Enfants"));
                ...
                mDialog = new Dialog(EnfantActivity.this);
    ...
    private void setupViewPager(ViewPager viewPager) {
        EnfantActivity.ViewPagerAdapter adapter = new EnfantActivity.ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFragment(new BabyFragment(),"Baby club");
        adapter.addFragment(new KidsFragment() , "Kidz Club ");
        adapter.addFragment(new RushFragment() , "Club Rush");
