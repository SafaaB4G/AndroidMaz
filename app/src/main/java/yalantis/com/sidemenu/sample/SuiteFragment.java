...
import static yalantis.com.sidemenu.sample.R.layout.activity_suite_fragment;

public class SuiteFragment extends ListFragment implements ImageGalleryAdapter.ImageThumbnailLoader, FullScreenImageGalleryAdapter.FullScreenImageLoader{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        l.add(new ListItem("Ocean View Mazagan Suite ", R.drawable.hebergement));
        l.add(new ListItem("Prime Ocean Mazagan Suite ", R.drawable.hebergement));
        l.add(new ListItem("Executive Suite", R.drawable.hebergement));
        l.add(new ListItem("Ambassadeur Suite ", R.drawable.hebergement));
        l.add(new ListItem("Royal Suite ", R.drawable.hebergement));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(activity_suite_fragment, container, false);
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch(position){
            case 0:
                ...
                photos = CallWebService.CallMazaganWebphoto("OceanViewMazaganSuite");
            ...
            case 1:
                ...
                photos = CallWebService.CallMazaganWebphoto("PrimeOceanMazaganSuite");
                Log.println(Log.ASSERT,"","photos Object 3amer"+photos);
                url= new ArrayList<String>() ;
                Log.println(Log.ASSERT,"","ghir les les url :"+url);
            ...
            case 2:
                ...
                photos = CallWebService.CallMazaganWebphoto("ExecutiveSuite");
                Log.println(Log.ASSERT,"","photos Object 3amer"+photos);
                url= new ArrayList<String>() ;
                Log.println(Log.ASSERT,"","ghir les les url :"+url);
            ...
            case 3:
                ...
                photos = CallWebService.CallMazaganWebphoto("AmbasadorSuite");
                Log.println(Log.ASSERT,"","photos Object 3amer"+photos);
                url= new ArrayList<String>() ;
                Log.println(Log.ASSERT,"","ghir les les url :"+url);
            ...
            case 4:
                ...
                photos = CallWebService.CallMazaganWebphoto("RoyalSuite");
                Log.println(Log.ASSERT,"","photos Object 3amer"+photos);
                url= new ArrayList<String>() ;
                Log.println(Log.ASSERT,"","ghir les les url :"+url);
