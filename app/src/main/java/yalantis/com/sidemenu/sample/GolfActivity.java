...
public class GolfActivity  extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    private void setupViewPager(ViewPager viewPager) {
        GolfActivity.ViewPagerAdapter adapter = new GolfActivity.ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFragment(new ParcourFragment(),"GARY PLAYER");
        adapter.addFragment(new AcademieFragment() ,"Académie");
        adapter.addFragment(new ProShopFragment(),"Pro-shop");
